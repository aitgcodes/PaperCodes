...
#usage python3 .py .cube - 10 20 // integrates upto 10 units  in y axis and 20 units in z axis
...
x_integ_length=sys.argv[2]       # Getting the input  for integ in x_axis
y_integ_length=sys.argv[3]       # Getting the input  for integ in y_axis
z_integ_length=sys.argv[4]       # Getting the input  for integ in z_axis
